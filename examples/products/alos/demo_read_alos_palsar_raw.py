...
# rootfilename, sl, el, ES, Ad, Be, Fc, Kr, H, V, PRF, Fs, Rnear = ('ALPSRP156110750', 1, 35344, [35344, 10344], 53.453 * PI / 180, 4.297680 * PI / 180, 1.27e9, -28.e6 / 27.0e-6, 698769., 7179.24, 2155.17, 32.00e+6, 846866.)
...
Description = {'Platform': 'ALOS', 'SensorType': 'PALSAR',
               'SensorMode': 'Fine(FBS)', 'DataType': 'RAW', 'DataSize': ['Nlines×Nsamples×2(IQ)', 0]}
...
D = copy.deepcopy(iprs.SarDataFileFileDescriptorRecordALOSPALSAR)
...
S = iprs.read_alos_palsar_raw(filepath, sl=sl, el=el, rmbp=False)
...
sardata.rawdata = S
sardata.name = 'ALOS_PALSAR_RAW=' + filename
sardata.image = []
