...
# Sr, targets = iprs.img2rawdata(sarplat, grayimg, bg=bgv, TH=0.5, noise=None, gdshape=None, mod='time', verbose=False)

Sr, targets = iprs.img2rawdata(sarplat, grayimg, bg=bgv, TH=0., noise=None, gdshape=None, mod='freq', verbose=False)
